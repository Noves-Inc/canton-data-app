...
You should be able to install v4 of the Noves App next to a standard Kubernetes Canton validator without reading the chart templates. An upgrade from v3.16.1 must stop before database mutation when you select the wrong persistent volume.
...
- a supported database from v3.16.1 of the Noves App;
