...
assert_contains "$chart/values.yaml" 'tag: "prod-f3f61cc1-1785419885"'
assert_contains "$chart/values.yaml" 'digest: "sha256:05d1ea7b8c1ae7c194b0f1a522ac17a75310928f5c425ebc7205b9c4560f0317"'
